...
<![endif]-->
      ...
      <div class="page-content back_to_up">
        <div class="row clearfix mb">
          <div class="breadcrumbIn">
            <ul>
              <li>
                <a href="index.html" class="toptip" title="Homepage">
  ...
  <script type="text/javascript" src="js/theme20.js">
  </script>
  ...
  <script type="text/javascript" src="js/twitter/jquery.tweet.js">
  </script>
