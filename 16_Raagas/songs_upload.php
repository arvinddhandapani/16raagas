...
.submit{background-color:#09f;border:0;padding:10px 40px;color:#FFF;border:#F0F0F0 1px solid; border-radius:4px;}
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form id="uploadForm" action="songs_upload_handler.php" method="post" enctype="multipart/form-data">
...
$(document).ready(function() { 
	 $('#uploadForm').submit(function(e) {	
		if($('#uploadedfile').val() || $('#uploadedfile2').val()) {
			e.preventDefault();
			$('#loader-icon').show();
			$(this).ajaxSubmit({ 
				target:   '#targetLayer', 
