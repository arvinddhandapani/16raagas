...
class ProcessForm
{
    ...
    function process()
    {
		...
		$file_name = $giname.$father.time().".".$imageFileType;
	    global $con;
	           $query_string = "INSERT INTO user_datails
	           (name, father_name, comment, image, dob, place, gender)
	           VALUES
	           ('$giname', '$father', '$comment', '$file_name', '$dob', '$place', '$gender')";
